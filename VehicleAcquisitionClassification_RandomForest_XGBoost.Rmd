---
title: "Project 4 (Spotting Clunkers): BAN 6053 - Introduction to Machine Learning"
...
```{r}
#setwd("C:/Users/tyler/OneDrive/Documents/Projects_and_homework/MSBA Fall 2021/BAN 6053 Intro. to Machine Learning/Project 4")
```

```{r}
training <- read_csv("project_4_training-2.csv") %>%
  clean_names() %>%
  mutate(is_bad_buy = as_factor(is_bad_buy))

kaggle <- read_csv("project_4_kaggle-2.csv") %>%
  clean_names()
```
...
write_csv(kaggle, "Project_4_Preds_TylerGrosman.csv")
```

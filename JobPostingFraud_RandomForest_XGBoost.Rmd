---
title: "Project 3: BAN 6053 - Introduction to Machine Learning"
...
```{r}
#setwd("C:/Users/tyler/OneDrive/Documents/Projects_and_homework/MSBA Fall 2021/BAN 6053 Intro. to Machine Learning/Project 3")
```
...
kaggle <- read_csv("job_holdout.csv") %>%
  clean_names()
```
...
# -- Score Training
predict(xgb_workflow1, kaggle, type = "prob")%>%
  bind_cols(predict(xgb_workflow1, kaggle, type = "class"))%>%
  bind_cols(., kaggle) -> holdout_score

#Submit to kaggle as CSV
kaggle <- holdout_score %>%
  dplyr::select(job_id, fraudulent = .pred_1)

write_csv(kaggle, "Project_3_Preds_TylerGrosman.csv")
```

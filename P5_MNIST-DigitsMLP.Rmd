...
train_test_spit <- initial_split(digit_train, prop = 0.7)
...
train_cv_folds <- vfold_cv(train_scaled, v = 5)
...
fit_control <- trainControl(method = "repeatedcv", 
                           ...
                           repeats = 5, 
                           classProbs = TRUE, 
                           summaryFunction = multipleClassification) # fix = Classification if necessary and change engine to "keras"
```{r}
